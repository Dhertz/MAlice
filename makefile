...
codegen: idents/Type.o idents/Callable.o idents/Number.o idents/Sentence.o \
	     ...
	     ast/FuncProcCallAST.o TreeWalker.o Utils.o Label.o ASTVisitor.o AssemCom.o AssemFunc.o InstructionPrinter.o ExprGen.o FunctionOptimiser.o Optimiser.o MAlice.o \
