...
compile: idents/Type.o idents/Callable.o idents/Number.o idents/Sentence.o \
	     ...
	     ast/IncAST.o ast/IfAST.o ast/ChoiceAST.o ast/WhileAST.o \
	     ast/PrintAST.o ast/StdinAST.o ast/VariableDecAST.o ast/VarAssignAST.o \
	     ...
	     ast/FuncAST.o TreeWalker.o Utils.o MAlice.o MAliceLexer.o \
