...
public:
	...
	static int evaluateExpression(pANTLR3_BASE_TREE root, boost::shared_ptr<SymbolTable> st);
	static void addCommand(list<AssemCom>& instrs, string name, string arg0);
	static void addCommand(list<AssemCom>& instrs, string name, string arg0, string arg1);
	static void addCommand(list<AssemCom>& instrs, string name, string arg0, string arg1, string arg2);
};
