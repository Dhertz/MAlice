    	...
    	if (children == 0) {
    		...
    		if (op == "!") {
			    if (!freeRegs.empty()) {
					...
					args.push_back("#1");
					AssemCom eor("eor", args.size(), args);
			...
			if (op == "||" || op == "|") {
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(lhsLoc);
    				args.push_back(rhsLoc);
    				AssemCom mul("mul", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				AssemCom moveq("moveq", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(reg);
    				args.push_back(reg);
    				AssemCom eoreq("eoreq", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(reg);
    				args.push_back("#0x7FFFFFFF");
    				AssemCom movgt("movgt", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(reg);
    				args.push_back("#0x7FFFFFFF");
    				AssemCom movlt("movlt", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(reg);
    				args.push_back("#0x7FFFFFFF");
    				AssemCom movge("movge", args.size(), args);
				...
				if (!freeRegs.empty()) {
    				...
    				args.push_back(reg);
    				args.push_back("#0x7FFFFFFF");
    				AssemCom movle("movle", args.size(), args);
